      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-gray-100">
        ...
        <div className="flex items-center justify-center w-full min-h-screen">
          <div className="bg-white rounded-lg shadow-lg flex flex-wrap w-full max-w-4xl">
            {/* Image Section */}
            <div className="bg-white-600 rounded-l-lg p-8 flex items-center justify-center w-full md:w-1/2">
              <img alt="signing in image" src={LoginBackgroundImage} className="w-full h-auto" />
            </div>
