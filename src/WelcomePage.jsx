      ...
      <section class="bg-gray-50 py-16">
         <div class="container mx-auto flex flex-col md:flex-row items-center">
            <div class="md:w-1/2">
               ...
               <div class="mt-6"> <a class="bg-orange-600 text-white px-6 py-3 rounded-md" href="/carrier-compass-ui/#/signup"> Get Started </a> <a class="ml-4 text-orange-600" href="#"> Explore more </a> </div>
            </div>
